...
The interactive piece is a scenario analyzer. The learner picks one of six secondary-use scenarios, scores risk along each of the five dimensions, and then sees a worked ethical analysis. The point is not to produce a number. The point is to make the dimensions visible so the conversation has a shape.
...
**What's next:** Track 04 on algorithmic fairness. Many of the equity concerns about secondary use surface most sharply in the AI/ML context, which Track 04 picks up directly.
