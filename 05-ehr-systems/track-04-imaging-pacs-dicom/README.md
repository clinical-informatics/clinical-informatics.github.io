...
The track puts a DICOM tag dump in front of you, presents the four-system architecture as a diagram, and surfaces the structural reason the radiology report on Ms. Reyes's chart is a PDF instead of a row in a structured-results table.
...
**How to start:** open `notebook.py` in Marimo. The notebook shows a synthetic DICOM tag dump for Reyes's 2024 hand-series instance, presents the four-system architecture interactively, and contrasts a structured-report and a PDF-report rendering of the same Sharp/van der Heijde score.

**Companion reading:** `04.1-imaging.md` in this folder is the reference essay.

**What's next:** Track 05 (real-world data quality), which covers the structured-versus-PDF gap that this track surfaces.
