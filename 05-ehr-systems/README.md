...
Click the Codespaces badge, wait about ninety seconds, and the course menu (`home.py`) will open in your browser. From the menu you can launch any track notebook or the capstone directly.
