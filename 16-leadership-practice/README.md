...
| ... | **Capstone** | Assemble the six track artifacts plus a risk register into the implementation plan for the RA-CDS the learner designed in Course 12. The 'now actually deploy it' capstone. |
