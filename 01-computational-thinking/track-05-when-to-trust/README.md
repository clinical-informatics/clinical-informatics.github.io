...
**What's next:** the course capstone. A Socratic walkthrough that designs a clinical decision rule using every move from the five tracks. The output is a written design document an implementation team could pick up.
