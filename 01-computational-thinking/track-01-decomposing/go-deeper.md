...
- The CDC's Hospital Toolkit for Adult Sepsis Surveillance. Free, government, opinionated about cohort definitions and case definitions in a way that maps directly onto the decomposition framework. Start at [cdc.gov/sepsis](https://www.cdc.gov/sepsis/) and look for the surveillance toolkit. The accompanying data dictionaries are where the six-part decomposition shows up explicitly: who counts, which signals, what thresholds, over what time window, from which source.
